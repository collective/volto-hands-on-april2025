...
2. Go to your repository at [collective/volto-hands-on](https://github.com/collective/volto-hands-on).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `volto-hands-on.example.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | volto-hands-on.example.com | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | volto-hands-on.example.com |
...
- [Backend Tests Workflow](https://github.com/collective/volto-hands-on/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/collective/volto-hands-on/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/collective/volto-hands-on-backend`) and Frontend (`ghcr.io/collective/volto-hands-on-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of volto-hands-on.example.com](https://github.com/collective/volto-hands-on/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/volto-hands-on.example.com.yml` stack.
